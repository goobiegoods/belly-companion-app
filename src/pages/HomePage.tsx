    ...
    <div className="min-h-screen bg-belly-bg pb-20">
      ...
      <div className="px-5 pt-5 pb-3 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-icon bg-belly-upsell-border flex items-center justify-center">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-belly-text-primary">
        ...
        <div className="bg-belly-upsell-bg border border-belly-upsell-border rounded-pill px-3 py-1.5">
          <span className="text-belly-accent text-xs">Hi, {profile?.first_name || "mama"} 🌸</span>
        </div>
      </div>
      ...
      <div className="px-5 mb-5">
        <div className="bg-primary rounded-hero p-5 relative overflow-hidden">
          ...
          <p className="text-xs text-primary-foreground/70 mb-4">{weekData.babySize} — {weekData.developmentHighlight.slice(0, 80)}...</p>
      ...
      <div className="mb-5">
        ...
        <div className="flex gap-3 px-5 overflow-x-auto hide-scrollbar">
          <div className="min-w-[130px] bg-card border border-belly-card-border rounded-[14px] p-3 belly-press">
          ...
          <div className="min-w-[130px] bg-card border border-belly-card-border rounded-[14px] p-3 belly-press">
            ...
            <p className="text-[11px] text-belly-text-muted line-clamp-2">{weekData.naturalTip.slice(0, 60)}...</p>
          </div>
        </div>
      </div>
